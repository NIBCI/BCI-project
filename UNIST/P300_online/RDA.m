                    ...
                    if param.switch_on %% check if one block end
                        ...
                        switch param.decoder.mode % check mode: training or testing
                            case 'training'
                                ...
                                if strcmp(InitVer,'AR') % save block data in mat file
                            ...
                            case 'testing'
                                ...
                                %                                     if mod(param.Numtrial,param.NumTeTrial) == 1
                                %                                         sess = sess + 1;
                                %                                         logger(sprintf('Session: %d',sess) , sess);
                                %                                         hit = 0;
                                %                                     end
                                if strcmp(InitVer,'AR')
...
%                                 logger(sprintf('True target: %d / Results: %d / Accuracy: %d', param.True_Tar, C, ACC), sess)
                                fprintf('Selected : %d \n',C);
                                ...
                                socket_sender(adip,C-1); % send result to controller
                                end
