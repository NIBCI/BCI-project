function [ Total_count, Trigger_Info ] = Grasping_MI()
%%
clc; clear all; tic
...
%% Load cue files 
% image load
cylindrical_arrow=imread('MotorImagery Stimulation Images\grasp.png'); 
spherical_arrow=imread('MotorImagery Stimulation Images\spread.png'); 
motor_imagery=imread('MotorImagery Stimulation Images\MI.jpg'); 
...
for trial=1:RepeatTimes
    ...
    switch sti_task(trial,1)
        case 1
            ...
            disp(sprintf('Command: Cylindrical Grasp\n'))
            
            ppTrigger(11);

            tex=Screen('MakeTexture', w, motor_imagery);
            Screen('DrawTexture', w, tex);
            Screen('Close',tex)
            [VBLTimestamp startrt]=Screen('Flip', w);
        ...
        case 2
            ...
            disp(sprintf('Data transmission'))
            disp(sprintf('Command: Spherical Grasp\n'))
