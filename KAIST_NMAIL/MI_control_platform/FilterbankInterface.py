...
freq = 500
channel_names = ['F5', 'FC5', 'C5', 'CP5', 'P5', 'FC3', 'C3', 'CP3', 'P3', 'F1', 'FC1', 'C1', 'CP1', 'P1', 'Cz', 'CPz',
...
folder = "Data"
data_type = "EEG_FBCSPinterface(testing)"
...
class FilterbankInterface:
    ...
    def __init__(self, filenames, nChannels=31, frequency=512, streamer_type="OpenVibe", channels=None, subject=None):
        ...
        self.model = FBCSP(nChannels=self.total_ch, frequency=freq, chnames=channel_names)
